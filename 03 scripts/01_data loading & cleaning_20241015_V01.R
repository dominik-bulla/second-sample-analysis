...
# baseline was commissioned as well. I designed the baseline framework, which included of a multi-stage sampling design. Data was 
# collected in country by local consultants. The data was collected using KOBO toolbox. The data was then pulled into R using an API. 
# I used the data collected in country to perform the global baseline analysis. Within the current excerpt from the global baseline 
# analysis, I determine the global average of the household heads as well as the proportion of household heads that are female. 
# To do so, I used sampling weights.
